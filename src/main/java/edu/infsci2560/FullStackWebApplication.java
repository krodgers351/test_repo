...
public class FullStackWebApplication {
    ...
    public static void main(String[] args) {
		...
		repository.save(new KMCatalogEntry(1L, "C# Coding Standards", "John Doe", "UnitA", x.categoryName, Community.Developers, "csharpstandard.pdf"));
        repository.save(new KMCatalogEntry(2L, "Contaminated Sample Procedure", "Jane Smith", "UnitC", y.categoryName, Community.Chemical_Engineers, "contaminated_sample_procedure.pdf"));
        repository.save(new KMCatalogEntry(3L, "Communications Wiring Diagram for Product X", "Jimmy Jones", "UnitB", z.categoryName, Community.Electrical_Engineers, "x_comms_wiring_diagram.pdf"));
